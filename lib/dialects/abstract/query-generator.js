  ...
  quote(collection, parent, connector) {
    ...
    if (collectionIsArray) {
      ...
      collection.forEach((item, index) => {
        ...
        let previousItemIsAssociation = previous && previous instanceof Association
        let noPreviousItem = !previous;
        ...
        let previousItemIsModel = previousModel && previousModel.prototype instanceof Model;
        if (previousItemIsModel) {
          let model;
          let as;

          let currentItemFunctionIsModel = typeof item === 'function' && item.prototype instanceof Model;
          let currentItemObjectIsModel = _.isPlainObject(item) && item.model && item.model.prototype instanceof Model
          ...
          if (model) {
            ...
            let itemIsAssociation = item instanceof Association;
        ...
        let itemIsString = typeof item === 'string';
        if (itemIsString) {
          // get order index
          const orderIndex = validOrderOptions.indexOf(item.toUpperCase());

          // see if this is an order
          let itemIsOrder = index > 0 && orderIndex !== -1;
          if (itemIsOrder) {
